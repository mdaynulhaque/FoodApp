    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header">
         <div class="row">
           <div class="col-md-6">
             <h4 class="">DISPLAY ALL PRODUCT NAME</h4>
           </div>
 ...
 <div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Product Name Insert</h5>
           ...
           <div class="row">
             <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" placeholder="Enter Product Name"
...
$(document).ready(function(){
  ...
  // Show data in page
   var table= $('#JsDataTable').DataTable({
    ...
    ajax:{
    url: "{{ route('admin.pro_name.index') }}",
    },
      columns:[
...
$('#create_record').click(function(){
    ...
    $('#sample_form')[0].reset();
    $('#form_result').html("");
    $('.modal-title').text("Add New Product Name");
...
// end  button id here
        ...
        if($('#action').val() == 'Add')
        {
        	action="pro_name/store";
        }
         if($('#action').val() == "Edit")

  		{
  			action="pro_name/update";
  		}
        $.ajax({
            url:action,
            method:"POST",
