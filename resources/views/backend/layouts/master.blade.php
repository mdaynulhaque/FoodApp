        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('app-assets/img/sidebar-bg/01.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('admin.dashboard') }}" class="logo-text float-left tex-normal">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h5">FoodDelivery</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.dashboard') }}"><i class="ft-home text-danger"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <li class="nav-item">
                            <a href="{{ route('admin.restuarant') }}"><i class="fa fa-university" style="color:tomato"></i><span data-i18n="" class="menu-title">All Restuarant</span></a>
                        </li> 
                         <li class="nav-item">
                            <a href="{{ route('admin.pro_name.index') }}"><i class="fa fa-desktop" style="color:tomato"></i><span data-i18n="" class="menu-title">All Product Name</span></a>
                        </li>  
                        <li class="nav-item">
                            <a href="{{ route('admin.category.index') }}"><i class="fa fa-signal" style="color:tomato"></i><span data-i18n="" class="menu-title">Category</span></a>
                        </li> 
                        <li class="has-sub">
                            <a href="#"><i class="fa ft-map-pin text-info" ></i><span>Location</span></a>
                            <ul class="menu-content">
                                <li class="nav-item">
                                     <a href="{{ route('admin.district.index') }}"><span data-i18n="" class="menu-title">District</span></a>
                                 </li>
                                  <li class="nav-item">
                                     <a href="{{ route('admin.thana.index') }}"><span data-i18n="" class="menu-title">Thana</span></a>
                                 </li>
                            </ul>
                        </li>
                         ...
                         <!-- <li class="nav-item">
                            <a href="{{ route('admin.contact') }}"><i class="fa fa-signal" style="color:tomato"></i><span data-i18n="" class="menu-title">Contacts</span></a>
                        </li>  
 -->
                    ...
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="dropdown nav-item"><a id="dropdownBasic3" href="#" data-toggle="dropdown"
                                    ...
                                    <img src="{{ asset('common/default-img/user.png') }}" alt="Admin-img" class="admin-img">
                                </a>
        ...
        <div class="main-panel">
            ...
            <footer class="footer footer-static footer-light">
               <p class="clearfix text-muted text-sm-center px-2"><span>Copyright &copy; All rights reserved in Haque-IT.
                    </span></p>
            </footer>
            <!-- End : Footer-->
