    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('app-assets/img/sidebar-bg/01.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('user.dashboard') }}" class="logo-text float-left tex-normal">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h5">FoodFry</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('user.dashboard') }}"><i class="ft-home text-danger"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <!-- <li class="nav-item">
                            <a href="{{ route('user.dashboard') }}"><i class="fa ft-shopping-cart text-danger"></i><span data-i18n="" class="menu-title">All Orders</span></a>
                        </li> -->
                         <li class="nav-item">
                            <a href="{{route('restuarant.product.index')}}"><i class="fa ft-shopping-cart text-danger"></i><span data-i18n="" class="menu-title">Food Items</span></a>
                        </li>
      ...
      <!-- Navbar (Header) Ends-->
        ...
        <div class="main-panel">
            ...
            <footer class="footer footer-static footer-light">
               <p class="clearfix text-muted text-sm-center px-2"><span>Copyright &copy; All rights reserved in FoodFry.
                    </span></p>
            </footer>
            <!-- End : Footer-->
