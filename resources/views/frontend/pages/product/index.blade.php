 ...
 <div class="modal-dialog  modal-xl">
  <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Product Addition</h5>
           ...
           <div class="row">
            ...
            <div class="row mb-2">
                <div class="form-group col-md-12">
                    ...
                    <textarea  class="form-control form-control-sm" placeholder="Enter Food Details" name="description" id="description" rows="3"></textarea>
                </div>
            </div>
...
$(document).ready(function(){
  ...
  // Show data in page
   var table= $('#JsDataTable').DataTable({
    ...
    ajax:{
    url: "{{ route('restuarant.product.index') }}",
    },
      columns:[
