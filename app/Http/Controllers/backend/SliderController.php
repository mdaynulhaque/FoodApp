            ...
            return datatables()->of($data)
                    ...
                    ->addColumn('image', function($data){
                     ...
                     ->addColumn('details', function($info){
                        $button ='<p class="mb-0"><b>Slider Title: </b>'.$info->title.' </p>';
                        $button .= '<p class="mb-0"> <b>Slider ButtonText: </b>'.$info->buttontext.' </p>';
                        $button .= '<p class="mb-0"> <b>Product ButtonLink: </b>'.$info->buttonlink.' </p>';
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $image_full_name = $image_name . '.' . $ext;
             ...
             $upload_path1 = 'public/images/slider/';
